...
def doNote2Cursor(args,timesofar,msg):
    ...
    y = msg.note / 128.0
    cid = "one"
    montage.SendCursorEvent(cid,cursorevent,x,y,0.5)
...
def doNote2Sprite(args,timesofar,msg):
    ...
    cid = "one"
    montage.SendSpriteEvent(cid,x,y,0.5)

def doNote2MIDI(args,timesofar,msg):
    montage.SendMIDIEvent(args.device,timesofar,msg)
...
if __name__=="__main__":
    ...
    parser.add_argument("-d", "--device", default="montage_midifile")
